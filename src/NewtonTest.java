class NewtonTest {
	...
	public static void main (String[] args) { 
		...
		System.out.println( "Test 16 " + (test16() ? "passed" : "failed" ));
		System.out.println( "Test 17 " + (test17() ? "passed" : "failed" ));
		System.out.println( "Test 18 " + (test18() ? "passed" : "failed" ));
		System.out.println( "Test 19 " + (test19() ? "passed" : "failed" ));
		System.out.println( "Test 20 " + (test20() ? "passed" : "failed" ));
	}
	...
	public static boolean test16() {
	    ...
	    try {
	        double result = p.solve(1, 1e-6, 200);
	...
	public static boolean test18() {
	    ...
	    try {
	        double result = p.solve(0, 1e-6, 200);
	        return Math.abs(result) < 1e-6;
	    } catch (SolutionNotFound s) {
	        return false;
	    }
	...
	public static boolean test19() {
	    ...
	    try {
	        ...
	        return (s.getMessage().equals(ITER));
	    }
	}
	...
	public static boolean test20() {
	    ...
	    try {
	        ...
	        return (s.getMessage().equals(DIVIDE));
	    }
	}
